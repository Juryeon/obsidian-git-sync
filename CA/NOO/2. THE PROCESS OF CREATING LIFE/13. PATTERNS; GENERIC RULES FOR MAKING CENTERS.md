...
But, of course, there is an enormous sub-ject, not yet dealt with at all: the question of the functional origin of a building, and the definition of the functions that are to go into it. In any sane process which is able to make living structure in buildings, giving proper

attention to the functional basis of the build-ing-to what people need, and want, and desire, in order to make themselves comfort-able - is paramount. For a building it is the essence of its worth.
