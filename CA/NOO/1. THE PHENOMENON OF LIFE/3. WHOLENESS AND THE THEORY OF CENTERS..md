...
and the dot, these parts and entities are rarely
...
or hardly visible coherent entities), “centers.”¹2
What this means is that each one of these enti-
ties has, as its defining mark, the fact that it ap-
...
marked coherence. Even when the center is a social
...
theory, I want be able to draw a precise boundary
...
pond"? How deep does it go? Do I include the
...
for me to draw an exact boundary, includ-
...
field effect in which the various elements work together to produce this phenomenon of a center.
This is true physically in the actual physical sys-tem of the pond: water, edge, shallows, gradi-ents, lilies-all help in the formation of the pond as a center. And it is also true mentally in my perception of that pond. That is why it is more
