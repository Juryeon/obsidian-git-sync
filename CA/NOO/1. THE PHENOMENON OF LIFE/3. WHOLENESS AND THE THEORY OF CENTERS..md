...
tional wisdom (perhaps Cartesian and mecha-nistic in origin) tells us that everything is made of parts. In particular, people believe today that every whole is made of parts. The key aspect of this belief is the idea that the parts come "before" the whole: in short, the parts exist as elements of some kind, which are then brought into relation-ship with one another, or combined, and a center is "created" out of these parts and their combina-tions as a result.
