...
나는 시작할 수 있기를 원한다.
나는 아직 시작하지 않고 있다.
하나님은 나에게 시작할 수 있는 신호를 주지 않으신다. 침묵하신다.
내가 시작하지 않는 것이 더 선한 것이다.
주님의 선한 뜻안에 내가 시작하지 않는 것, 내가 시작하지 못해 괴로운 것이 나중에 참 다행이었다고 말할만한 일일 것이다.
그렇다면 나는 어떻게 반응하고, 어떻게 지금을 보내야하는가

지금도 주님의 계획안에 있다.
어느것을 해도 주님이 나와 함께 하신다고 한다.
나도 주님과 함꼐 하기 위해 하는 선택이길원한다.
